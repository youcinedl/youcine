      ...
      <section className="py-16 relative z-20 bg-dark-800/30 border-b border-white/5">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mb-10">
            ...
            <Link href="/youcine-para-pc" className="bg-[#fbbf24] hover:bg-[#f59e0b] text-black font-bold py-5 px-2 rounded-xl flex flex-col items-center justify-center transition-transform hover:-translate-y-1 shadow-lg shadow-[#fbbf24]/20 text-center">
              <span>💻 Youcine APK for</span>
              <span>PC</span>
            </Link>
            <Link href="/youcine-smart-tv" className="bg-[#fbbf24] hover:bg-[#f59e0b] text-black font-bold py-5 px-2 rounded-xl flex flex-col items-center justify-center transition-transform hover:-translate-y-1 shadow-lg shadow-[#fbbf24]/20 text-center">
              <span>📺 Youcine APK for</span>
              <span>TV</span>
            </Link>
            <Link href="/youcine-ios" className="bg-[#fbbf24] hover:bg-[#f59e0b] text-black font-bold py-5 px-2 rounded-xl flex flex-col items-center justify-center transition-transform hover:-translate-y-1 shadow-lg shadow-[#fbbf24]/20 text-center">
              <span>🍎 Youcine APK for</span>
              <span>iOS</span>
            </Link>
          </div>
