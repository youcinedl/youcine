...
export default function YouCineSmartTVPage() {
  const tvFaqs = [
    ...
    },
    {
      ...
      answer: <>Yes, but only if you download it from a trusted website like <Link href="/" className="text-primary hover:underline font-semibold">youcine-dl.com</Link>. Always avoid unknown or shady websites to keep your device safe.</>
    },
    {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 xl:gap-12" id="download-section">
        ...
        <div className="lg:col-span-8 space-y-12 sm:space-y-16">
          ...
          <section className="space-y-6">
            ...
            <p className="text-slate-300 text-base sm:text-lg leading-relaxed">
              Youcine APK is a free streaming app that was first built for Android phones. Now, it has grown way beyond that — millions of people are using it on Smart TVs, Fire Sticks, and TV Boxes, because watching on a big screen just feels better. If you also stream on other setups, learn how to run the player on your computer display using <Link href="/youcine-para-pc" className="text-primary-light hover:underline font-semibold">YouCine for PC</Link>, or install it on Apple devices with our guide to <Link href="/youcine-ios" className="text-primary-light hover:underline font-semibold">YouCine for iOS</Link>.
            </p>
          ...
          <section className="space-y-6">
            ...
            <div className="glass-panel border-green-500/15 bg-green-955/5 p-6 rounded-2xl space-y-2">
              ...
              <p className="text-slate-300 text-xs sm:text-sm leading-relaxed pl-7">
                Always download Youcine from a website you can trust. We recommend <Link href="/" className="text-primary-light hover:underline font-bold">youcine-dl.com</Link> — it's clean, safe, and completely free of viruses or malware. Thousands of users download from it every day without any issues.
              </p>
