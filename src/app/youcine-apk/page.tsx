      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 prose prose-invert prose-lg max-w-none">
          ...
          <p className="text-slate-300">
            Installing YouCine on your Android device is straightforward. Since it's a third-party application not available on the Google Play Store, you'll need to download the APK file directly and sideload it. If you want to watch on other devices, check out our comprehensive setup guides for <Link href="/youcine-para-pc" className="text-primary hover:underline font-semibold">YouCine on PC</Link>, <Link href="/youcine-smart-tv" className="text-primary hover:underline font-semibold">YouCine on Smart TV</Link>, and <Link href="/youcine-ios" className="text-primary hover:underline font-semibold">YouCine on iOS</Link>.
          </p>
