      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2 prose prose-invert prose-lg max-w-none">
          ...
          <p className="text-slate-300">
            Ter o YouCine na sua TV é a melhor forma de aproveitar filmes e séries em família. O processo é simples para TVs com sistema Android TV ou TV Box. Se você deseja usar o aplicativo em outras plataformas, leia nossos guias detalhados sobre <Link href="/youcine-apk" className="text-primary hover:underline font-semibold">YouCine APK para celular</Link>, <Link href="/youcine-para-pc" className="text-primary hover:underline font-semibold">YouCine para computador (PC)</Link>, ou <Link href="/youcine-ios" className="text-primary hover:underline font-semibold">YouCine para dispositivos iOS</Link>.
          </p>
